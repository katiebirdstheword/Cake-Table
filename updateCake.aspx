<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="updateCake.aspx.cs" Inherits="CakeTable.updateCake" %>
...
<br />
            ...
            <asp:CheckBoxList ID="CheckBoxList1" runat="server" BorderColor="Black"></asp:CheckBoxList>
...
<asp:TextBox runat="server" ID="txtCreatedDate"></asp:TextBox>
            ...
            <br /><br />
        <p><asp:Button Text="Update Cake" runat="server" ID="BtnSave" OnClick="BtnUpdate_Click" class="btn btn-success"/></p>
